...
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, IMDB, \
    SINGLE_BUTTON, SPELL_CHECK_REPLY, IMDB_TEMPLATE, IS_VERIFY
...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("⚠️ Hey Friend That's Not For You Please Search Your Own", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"© Bot Managed By @Bot_Updates_Channel ★Here is what i found for your query {search}"
